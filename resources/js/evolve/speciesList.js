...
(function() {
  ...
  SpeciesList = (function() {
    ...
    SpeciesList.prototype._windowResized = function() {
    ...
    SpeciesList.prototype._documentScrolled = function(e) {
      $.debug(e);
      return $("div.dropTarget").css("top", $(document).scrollTop());
    };

    SpeciesList.prototype._displayAncestorCallback = function(species) {
      var speciesDiv;
    ...
    SpeciesList.prototype._ancestorTemplate = "<div class='ancestor species' data-key='{pk}'>{name} ({scoreList})</div><div class='divider' />";

    SpeciesList.prototype._generateSpecieDiv = function(specie) {
    ...
    SpeciesList.prototype._displayChildrenCallback = function(species) {
    ...
    SpeciesList.prototype._makeDraggable = function(element) {
    ...
    SpeciesList.prototype._displayCode = function(specie, target) {
      var codeArray;
    ...
    SpeciesList.prototype._displayDiffIfTwoCodesAreDisplayed = function() {
    ...
    SpeciesList.prototype.displayAncestor = function(species) {
    ...
    SpeciesList.prototype.displayChildren = function(species) {
  ...
  CORE.speciesList = function() {
    return this._speciesList || (this._speciesList = new SpeciesList());
  };

  jQuery(document).ready(function() {
    return CORE.speciesList();
  });
